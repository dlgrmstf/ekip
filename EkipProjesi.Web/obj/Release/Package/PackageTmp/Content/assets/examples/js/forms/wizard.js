    ...
    (function () {
        ...
        var options = $.extend(true, {}, defaults, {
            ...
            validator: function () {
                ...
                var $this = $(this);
                var func = $this.attr("data-validator");
          ...
          templates: {
              buttons: function () {
                  ...
                  var html = '<div class="btn-group btn-group-sm">' +
                    '<a class="btn btn-round btn-primary btn-pill-left" href="#' + this.id + '" data-wizard="back" role="button">' + options.buttonLabels.back + '</a>' +
                    ...
                    '<a class="btn btn-round btn-primary btn-pill-right" href="#' + this.id + '" data-wizard="next" role="button">' + options.buttonLabels.next + '</a>' +
                    '</div>';
                  return html;
              }
          },
