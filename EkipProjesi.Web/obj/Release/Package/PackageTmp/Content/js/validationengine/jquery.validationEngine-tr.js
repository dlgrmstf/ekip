        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "phone": {
                    ...
                    "regex": /^\d{1}\((\d{3})\)\s(\d{3})\s(\d{2})\s(\d{2})/,
                ...
                "onlyLetterSpSmall": {
                    "regex": /^[a-z\ \']+$/,
                    "alertText": "* Bu alanda sadece küçük harf olmalı"
                },
                "onlyLetterSpTurkce": {
                    "regex": /^[^ığüşçö]+$/,
                    "alertText": "* Bu alana Türkçe karakterler girilemez"
                },
                "integer": {
                    "regex": /^[\-\+]?\d+$/,
                ...
                "date": {
                    ...
                    "alertText": "* Geçersiz tarih. (Örn: 15.07.2016 - GG.AA.YYYY formatında olmalıdır.)"
                },
                "ipv4": {
                ...
                "url": {
                    ...
                    "alertText": "* Geçersiz URL (Örnek: http:finansmuduru.com.tr şeklinde yazınız.)"
                },
                "onlyNumberSp": {
                    "regex": /^[0-9\ ]+$/,
