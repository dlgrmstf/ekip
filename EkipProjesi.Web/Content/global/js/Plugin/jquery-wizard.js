                ...
                return {
                    ...
                    templates: {
                        buttons: function buttons() {
                            ...
                            return '<div class="wizard-buttons"><a class="btn btn-primary btn-round btn-pill-left" href="#' + this.id + '" data-wizard="back" role="button">' + options.buttonLabels.back + '</a><a class="btn btn-primary btn-round float-right btn-pill-right" href="#' + this.id + '" data-wizard="next" role="button">' + options.buttonLabels.next + '</a><a class="btn btn-success btn-outline float-right" href="#' + this.id + '" data-wizard="finish" role="button">' + options.buttonLabels.finish + '</a></div>';
                        }
                    },
                    classes: {
                        step: {
